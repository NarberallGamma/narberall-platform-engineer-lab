...
Case studies (outcomes) + [`experience.md`](experience.md) (six years) + [`iac/cloud/`](../iac/cloud/) (keywords) + [`iac/terraform/`](../iac/terraform/) (code) + [`iac/ansible/`](../iac/ansible/) (hosts) + [`iac/helm/`](../iac/helm/) (cluster) + [`iac/helm/apps/`](../iac/helm/apps/) (product samples) + [`iac/docker/`](../iac/docker/) (images and Compose) + [case 10](../case-studies/10-ansible-estate.md) + [case 11](../case-studies/11-helm-estate.md) + [case 12](../case-studies/12-docker-images.md) + live portfolio site.  
