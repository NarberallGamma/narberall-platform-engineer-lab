...
#                                 user, password, socket, etc. (innobackupex
...
#                                 innobackupex. If the innobackupex option has a
#                                 value, pass it either with an equals sign
#                                 ( = ) (long options only) or with a space,
#                                 in which case the innobackupex option and its
...
#                                 all listed options are passed to innobackupex
...
"innobackupex --defaults-file='${DEFAULTS_FILE}' ${EFFECTIVE_OPTIONS} --stream=xbstream ./"
