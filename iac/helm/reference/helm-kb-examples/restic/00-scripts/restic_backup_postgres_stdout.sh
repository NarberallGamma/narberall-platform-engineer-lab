...
#   - back up the tar archive with restic, reading it from stdin
...
#    --skip-hostname-prefix      - omit the host field from the restic repository
#                                  the backup tag is used as hostname
