...
Hunter-facing map. **Code** lives under [`reference/`](reference/) (sanitized), same pattern as [`../terraform/`](../terraform/). **Story** lives under [`../../practice/home-lab/edge-platform.md`](../../practice/home-lab/edge-platform.md) and [`../../case-studies/08-payments-swarm-autodeploy.md`](../../case-studies/08-payments-swarm-autodeploy.md).
...
| [`reference/ansible-runner/`](reference/ansible-runner/) | Control-node image: ansible-core + jmespath, `--network host` |
...
Handoff for the next Ansible thicken pass: [`../../TEMP_ANSIBLE_NEXT.md`](../../TEMP_ANSIBLE_NEXT.md) (delete when that pass is done).
