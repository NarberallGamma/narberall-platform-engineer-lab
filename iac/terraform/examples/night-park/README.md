...
Business story: [`../../../../architecture/02-finops-night-park.md`](../../../../architecture/02-finops-night-park.md). Operator image that calls the provider stop/start API: [`../../../docker/images/operators/hibernate/`](../../../docker/images/operators/hibernate/).
