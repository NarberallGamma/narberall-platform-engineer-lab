...
| controllerImage | string | `"example.registry/linkerd/controller"` | Docker image for the destination and identity components |
...
| debugContainer.image.name | string | `"example.registry/linkerd/debug"` | Docker image for the debug container |
...
| proxy.image.name | string | `"example.registry/linkerd/proxy"` | Docker image for the proxy |
...
| proxyInit.image.name | string | `"example.registry/linkerd/proxy-init"` | Docker image for the proxy-init container |
