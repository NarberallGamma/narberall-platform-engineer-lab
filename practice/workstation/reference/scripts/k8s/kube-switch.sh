...
# Использование: 
#   ./kube-switch.sh                    # Интерактивный выбор кластера
#   ./kube-switch.sh <cluster-name>     # Переключение на указанный кластер
#   ./kube-switch.sh list               # Показать список доступных кластеров
#   ./kube-switch.sh current            # Показать текущий активный кластер
