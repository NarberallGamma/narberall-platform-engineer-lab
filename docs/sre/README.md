...
**Business:** a breach should page a human who can act, not a dashboard nobody owns. This catalog is the **experience map**: stacks I ran, how host and cluster layers stay complementary, and pointers to the living Helm / Ansible / exporter trees in this lab.
...
| Cases | [10](../../case-studies/10-ansible-estate.md), [11](../../case-studies/11-helm-estate.md) |

Vendor Grafana / Prometheus / OpenObserve chart **trees** stay out of git. What is published is the overlay I maintained and the host kits that scrape.
