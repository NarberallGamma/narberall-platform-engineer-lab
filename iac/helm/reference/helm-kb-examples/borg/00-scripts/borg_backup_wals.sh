...
# ${1} - Переопределяем имя архива. Обязательный аргумент
# ${2} - путь к каталогу с архивами WAL-файлов. Обязательный аргумент
# ${3} - максимальное время жизни WAL-файлов в минутах, WAL-файлы с большим
