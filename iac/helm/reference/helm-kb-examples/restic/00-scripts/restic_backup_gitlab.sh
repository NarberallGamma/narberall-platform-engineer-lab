...
00-scripts/restic_backup_files.sh "${NAME:-${NAMEOFBACKUP_DEFAULT}}" "/etc/gitlab,/var/opt/gitlab/backups" --prune "${CUSTOMPRUNE:-${CUSTOMPRUNE_DEFAULT}}" --dont-ignore-missing-files

find /var/opt/gitlab/backups -type f -mtime +3 -ls -delete
