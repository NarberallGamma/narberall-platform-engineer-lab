...
PLAYBOOK="playbooks/migrate_hsm_adapter_legacy.yml"
INVENTORY=""
LIMIT_ARG=""
SCOPE_SPECIFIED=""
SSH_KEY_PATH=""
...
Examples:
  ...
  ./scripts/run/run_migrate_hsm_adapter_legacy.sh --prod --limit estate-prod-cryptopro-01
  ./scripts/run/run_migrate_hsm_adapter_legacy.sh --preprod --limit estate-preprod-hsm-adapter -- --tags prepare
EOF
      exit 0
      ;;
    *) EXTRA+=("$1"); shift ;;
