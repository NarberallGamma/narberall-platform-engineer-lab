...
- Observability / SRE: Prometheus + Alertmanager + Grafana, **OpenObserve** + OTel Collector, Loki, ELK/Logstash, Graylog, Jaeger. Alerts on-call can act on.
