...
| Path | Use |
|------|-----|
| [`case-studies/`](case-studies/) | Architecture for published case studies (01-12, including Selectel, Huawei-class estate Ansible, estate Helm, and Docker / Compose) |
| [`iac/`](iac/) | CI turnkey (Jenkins + GitLab CI, build/publish/revoke), Helm estate kits, and Docker / Compose |
