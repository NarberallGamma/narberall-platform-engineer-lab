...
Used by: [`../ansible-bootstrap/`](../ansible-bootstrap/), [`../ansible-edge/`](../ansible-edge/). Agent wrapper (native or this image): [`../../../../practice/workstation/reference/scripts/utility/ansible/ansible_agent_run.sh`](../../../../practice/workstation/reference/scripts/utility/ansible/ansible_agent_run.sh).
