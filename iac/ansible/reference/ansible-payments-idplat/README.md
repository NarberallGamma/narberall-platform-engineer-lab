...
This is **application autodeploy**, not host bootstrap. Host baseline stays in [`../ansible-bootstrap/`](../ansible-bootstrap/). Hunter map: [`../../`](../../). Case study: [`../../../../case-studies/08-payments-swarm-autodeploy.md`](../../../../case-studies/08-payments-swarm-autodeploy.md).
