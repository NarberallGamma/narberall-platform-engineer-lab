...
#                                  all listed options are passed to mongodump.
#                                  Optional
...
# --skip-hostname-prefix) or the full Borg repository name (with
# --skip-hostname-prefix). Required
# ${2} - Mongo connection address. Required if -h|--host is NOT used
