...
| defaultRegistry | string | `"example.registry/linkerd"` | Docker registry for all viz components |
...
| namespaceMetadata.image.tag | string | `"v0.1.6"` | Docker image tag for the namespace-metadata instance |
...
| prometheus.image.registry | string | `"example.registry"` | Docker registry for the prometheus instance |
